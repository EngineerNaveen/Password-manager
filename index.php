...
<head>
    ...
    <title>Home | Online Password Saving</title>
    ...
    <div class="container">
        ...
        <div class="header">
            <div class="header-left">
                <div class="logo">
                    <a href="index.php">Password  Saver</a>
                </div>
        ...
        <div class="center-part">
            <div class="center-left">
                <button>
                   <a href="php/create.php">Save New Password</a>
                </button>
            </div>

            <div class="center-right">
                <div class="table-view">
                    <div class="head">Account Name</div>
                ...
                $sql="SELECT * FROM `pass_records` WHERE `s_no_user` = '$s_no'";
